...
class CheckIdealController extends Controller
{
    public function index()
    {
        $check_ideal = $cetegory = DB::table('check_ideal')
        ->get();
        return response([
            'success' => true,
    ...
    public function bmiStore(Request $request)
    {
        ...
        if($validator->fails()) {
            ...
            if ($CheckIdeal) {
                return response()->json([
                    'success' => true,
                    'message' => 'CheckIdeal Berhasil Disimpan!',
                    'data' => [
                        'nama'     => $request->nama,
                ...
                return response()->json([
                    'success' => false,
                    'message' => 'CheckIdeal Gagal Disimpan!',
                ], 400);
            }
        }
    }
